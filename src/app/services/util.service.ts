...
export class UtilService {
  ...
  private useaddress = new Subject<any>();
  ...
  */
  ...
  getKeys(key): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.storage.get(key).then((data) => {
        ...
        console.log("getKeys error ====>"+error);
        reject(error);
      });
    });
  }
  ...
  clearKeys(key) {
    ...
    console.log("clearKeys ====>"+key);
  }

  setKeys(key, value): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.storage.set(key, value).then((data) => {
        console.log("setKeys Data ====>"+data);
        resolve(data);
      }).catch(error => {
        console.log("setKeys error ====>"+error);
        reject(error);
      });
    });
  }
  ...
  publishUseAddress(data: any) {
    this.useaddress.next(data);
  }
  getObservableAddress(): Subject<any> {
